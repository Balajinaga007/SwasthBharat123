...
const Footer = () => {
  return (
    <footer className="niti-footer">
      ...
      <p class="text-[#EBEAEA] text-14-scale text-14-scale-lg md:w-[22.125rem] ">A GOI initiative to ensure holistic, lifelong well-being through digital tools, expert knowledge, and continuous support.</p>
